...
def send_email(subject: str, body_text: str, body_html: str | None = None, recipients: list | None = None):
...
def markdown_to_html(markdown_text: str) -> str:
    rendered = markdown.markdown(markdown_text, extensions=["extra", "nl2br"])
